...
//		BookServices bookImpl = new BookServiceImpl(lib);
		...
		Validate validate = new ValidateServiceImpl();
		...
		do {
			...
			case 1:
				...
				if (validate.login(users)) {

					if ("ADMIN".equals(validate.authorizeUser(users))) {
					...
					else if ("STUDENT".equals(validate.authorizeUser(users))) {
